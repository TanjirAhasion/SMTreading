...
namespace SMT.Application.DTO.Items
{
    ...
    public record ProductListDto(long Id, string Name, string? Model, long BrandId, string BrandName, decimal DefaultSalePrice, decimal DefaultRentPrice, int? LowStockThreshold, int? inStock, int inRent, bool IsActive);
